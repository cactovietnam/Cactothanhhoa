...
sbFix.BackgroundColor3=Color3.fromRGB(13,13,20); sbFix.BorderSizePixel=0; sbFix.ZIndex=6
local sbLayout = Instance.new("UIListLayout", sidebar)
sbLayout.Padding=UDim.new(0,3); sbLayout.SortOrder=Enum.SortOrder.LayoutOrder
local sbPad = Instance.new("UIPadding", sidebar)
sbPad.PaddingTop=UDim.new(0,10); sbPad.PaddingLeft=UDim.new(0,8); sbPad.PaddingRight=UDim.new(0,8)

local sbDiv = Instance.new("Frame", win)
sbDiv.Size=UDim2.new(0,1,1,-47); sbDiv.Position=UDim2.new(0,130,0,47)
sbDiv.BackgroundColor3=Color3.fromRGB(35,35,55); sbDiv.BorderSizePixel=0; sbDiv.ZIndex=6

-- =================== CONTENT AREA ===================
local content = Instance.new("Frame", win)
content.Size             = UDim2.new(1,-131,1,-47)
content.Position         = UDim2.new(0,131,0,47)
